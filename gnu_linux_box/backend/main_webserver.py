...
from api.NamedEntityRecognitionApi import NamedEntityRecognitionApi
from api.KeywordExtractionApi import KeywordExtractionApi 
...
api.add_resource(NamedEntityRecognitionApi, "/named_entity_recognition_query", resource_class_args=[tools])
api.add_resource(KeywordExtractionApi, "/keyword_extraction_query", resource_class_args=[tools])
