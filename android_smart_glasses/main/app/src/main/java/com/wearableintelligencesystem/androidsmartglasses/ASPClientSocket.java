...
//        stopThread(ReceiveThread);
    ...
    private void parseData(JSONObject data){
        try {
            ...
            String [] uiMessages = new String[] {MessageTypes.KEYWORD_RESULT, MessageTypes.NATURAL_LANGUAGE_QUERY, MessageTypes.SEARCH_ENGINE_RESULT, MessageTypes.VISUAL_SEARCH_RESULT, MessageTypes.TRANSLATION_RESULT, MessageTypes.ACTION_SWITCH_MODES};
